...
import '../EdibleMushrooms/EdibleMushrooms.css';


class PoisonousMushrooms extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      mushrooms: [],
  ...
  componentDidMount() {
    axios.get('https://localhost:7199/IadovGrib')
      .then(response => {
...
export default PoisonousMushrooms;